...
DROP TABLE IF EXISTS cliente_ea;
...
DROP TABLE IF EXISTS comuna_ea;
...
DROP TABLE IF EXISTS formapago_ea;
...
DROP TABLE IF EXISTS listaformapago_ea;
...
DROP TABLE IF EXISTS listmedicamentos_ea;
...
DROP TABLE IF EXISTS medicamentos_ea;
...
DROP TABLE IF EXISTS pedido_ea;
...
DROP TABLE IF EXISTS tipomedicamneto_ea;
...
DROP TABLE IF EXISTS vendedor_ea;
